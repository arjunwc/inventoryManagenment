...
class CategoryController extends Controller
{
    public function index()
    {
        ...
        $output['module_name'] = "Category Management";
        $output['module_page'] = "List of Category";
        return view('admin.category.index', $output);
    }
    ...
    public function get_list(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $html    = "";
            $records = Category::where($search)->orderBy('created_at', 'DESC')
                ->paginate($page_limit);
            $response['success']    = true;
            $response['html']       = view('admin.category.list', ['records' => $records])->render();
    ...
    public function get_record_by_id($id)
    {
        ...
        return view('admin.category.add', $output);
    }
        ...
        if ($request->isMethod('post')) {
            ...
            if (!$validator->fails()) {
                ...
                if ($insert_record->id) {
                    ...
                    $response['redirectURL'] = url('administrator/category');
                } else {
    ...
    public function update(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            if (!$validator->fails()) {
                ...
                $affectedRows = Category::where('id', $update['id'])->update($update);
                if ($affectedRows) {
                    $response['success']     = true;
    ...
    public function change_status($id, $status)
    {
        ...
        $user                = Category::where('id', $id)->update($update);
        $response['success'] = true;
