...
<tr>
	...
	<td><?php echo ucfirst($value->subcat->title) ?></td>
	<td>
		<div class="btn-group">
	...
	<a class="btn btn-xs btn-info btn-edit" title="Edit Data" href="<?php echo url('administrator/sub-sub-category/update/'.$value->id) ?>"><i class="fa fa-pencil"></i></a>
