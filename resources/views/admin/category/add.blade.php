      ...
      <div>
         ...
         <div class="panel panel-default">
            ...
            <div class="panel-body" style="padding:20px 0px 0px 0px">
               ...
               <form class="form-horizontal ajax_form" method="post" id="form" enctype="multipart/form-data" action="{{url('administrator/category/update_record')}}" autocomplete="off">
               <?php }else{ ?>
               <form class="form-horizontal ajax_form" method="post" id="form" enctype="multipart/form-data" action="{{url('administrator/category/add')}}" autocomplete="off">
               <?php } ?>   
