...
function getList() {
        ...
        if(userType=="Admin"){
          ...
          var url=baseUrl + "storelist?title=" + title+'&per-page='+page+'&user_id='+user_id;
        }else{
          var url=baseUrl + "storelist?title=" + title+'&per-page='+page;
        }
        $.ajax({
            url: url,
            type: 'get',
    ...
    function fetch_date(page) {
        ...
        if(userType=="Admin"){
          var user_id = $('#user_id').val();
          var url=  baseUrl + "storelist?title=" + title + '&page=' + page+'&per-page='+pages+'&user_id='+user_id;
        
        }else{
          var url=baseUrl + "storelist?title=" + title + '&page=' + page+'&per-page='+pages;
        }
        $.ajax({
            url: url,
            type: 'get',
