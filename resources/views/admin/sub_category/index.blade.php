...
<div class="content-wrapper" style="min-height: 926px;">
  <section class="content-header">
    ...
    <a href="{{url('administrator/sub-category/add')}}" id="btn_add_new_data" class="btn btn-sm btn-success" title="Add Data">
...
function getList() {
        ...
        var url=baseUrl + "sub-categorylist?title=" + title+'&per-page='+page+'&user_id='+user_id;
        }else{
        var url=baseUrl + "sub-categorylist?title=" + title+'&per-page='+page;
        }
    ...
    function fetch_date(page) {
        ...
        var pages = $('#page').val();
          if(userType=="Admin"){
          var user_id = $('#user_id').val();
          var url=  baseUrl + "sub-category?title=" + title + '&page=' + page+'&per-page='+pages+'&user_id='+user_id;

          }else{
          var url=baseUrl + "sub-category?title=" + title + '&page=' + page+'&per-page='+pages;
          }
        $.ajax({
            url: url,
            type: 'get',
    ...
    function deleteRecord(id) {
      swal({
            ...
            closeOnConfirm: false
              ...
              $.get(baseUrl + "sub-category/delete/" + id, function(data, status) {
                if (data.success) {
...
function changeSatus(id, status) {
    $.ajax({
        url: baseUrl + "sub-category/change_status/" + id + "/" + status,
        type: 'get',
        dataType: 'json',
        beforeSend: function() {},
        complete: function() {},
