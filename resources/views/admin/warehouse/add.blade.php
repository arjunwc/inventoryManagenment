   ...
   <section id="content_section" class="content">
      ...
      <div class="panel panel-default">
         ...
         <div class="panel-body" style="padding:20px 0px 0px 0px">
            ...
            <form class="form-horizontal ajax_form" method="post" id="form" enctype="multipart/form-data" action="{{url('administrator/warehouse/update_record')}}" autocomplete="off">
               <?php }else{ ?>
               <form class="form-horizontal ajax_form" method="post" id="form" enctype="multipart/form-data" action="{{url('administrator/warehouse/add')}}" autocomplete="off">
                  <?php } ?>
                  ...
                  <div class="form-group header-group-0 " id="form-group-address" style="">
                     ...
                     <div class="col-sm-9">
                        <textarea name="address" id="address" class="form-control" rows="5"><?php if(isset($record->address) && $record->address!=""){ echo $record->address;  }?></textarea>
                        <div class="text-danger"></div>
                        <p class="help-block"></p>
                     </div>
                  </div>
                  ...
                  <div class="box-footer" style="background: #F5F5F5">
                     <div class="form-group">
                        ...
                        <div class="col-sm-10">
                           <a href="{{url('administrator/category')}}" class="btn btn-default"><i class="fa fa-chevron-circle-left"></i> Back</a>
                           <?php if(isset($record->id) && $record->id!=""){ ?>
